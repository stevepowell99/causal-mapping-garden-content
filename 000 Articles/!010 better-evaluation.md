...
![Causal map from the Causal Map App showing text boxes connected from left to right by arrows](img/screenshot-causal-map-from-the-causal-map-app-showing-text-boxes-connected-from-l.jpg)
