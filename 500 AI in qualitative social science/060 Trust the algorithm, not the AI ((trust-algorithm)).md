...
The alternative (precursor) to algorithms is trusting humans to make decisions. This can be great if humans consider context and individual circumstances, what Scott calls "mētis," or local, practical, tacit knowledge [@scottSeeingStateHow2020] but it can also lead to bias and corruption.

We can see **rubrics in evaluation** [@kingEvaluativeRubricsMethod2013] as a kind of soft algorithm. We usually welcome rubrics because they make evaluation criteria more explicit, transparent, and less subject to the whims and unreliability of individuals.
...
![](img/060-trust-the-algorithm-not-the-ai-trust-algorithm.jpg)
