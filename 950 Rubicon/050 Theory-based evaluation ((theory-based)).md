...
The counting step produced two figures per link and one for the theory as a whole. The whole-theory figure is **572 supporting quotes**. Per link, the count of supporting passages runs from 56 on "training leads to increased farming knowledge" to 100 on "better health practices lead to improved family health". The two health links thus rest on roughly half again as much material as any of the others. All eight links were counted. None came back empty.
