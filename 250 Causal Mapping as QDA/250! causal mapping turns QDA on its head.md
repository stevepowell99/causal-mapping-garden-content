...
> **SOURCE NOTE (consolidation):** This file is a draft/fragment within a larger working-paper set (hub: [[000 Working Papers ((working-papers))]]). The flagship QDA-facing paper is: [[040 Causal mapping as causal QDA ((causal-qda))]].  
> Core coding stance: [[005 Minimalist coding for causal mapping ((minimalist))]]. Companion methods notes: [[900 Magnetisation ((magnetisation))]]; [[900 A simple measure of the goodness of fit of a causal theory to a text corpus ((goodness-of-fit))]].
