...
![[100 Task 3 -- Answering questions -- Individual questions/img/map-116-source-tracing-what-are-the-consequences-of-one-or-more-factors-lo.png]]
- Avoid the "transitivity trap": if source 'A' says that _sanitation_ influenced _wellbeing_, and source 'B' says that _wellbeing_ influenced _peace_, you have to be careful in concluding that _sanitation_ influenced _peace_.
