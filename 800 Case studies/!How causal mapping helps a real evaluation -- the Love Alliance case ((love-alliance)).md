...
![[800 Case studies/img/map-love-alliance-theory-of-change.png]]
*Figure 1. The programme's official theory of change: a layered ladder from strategies up to goals.*
...
![[800 Case studies/img/map-love-alliance-movement-building.png]]
*Figure 3. The movement-building view. "Partner organisations implement networking activities, collaborations and build alliances" is the central hub, with reinforcing feedback loops around it.*
...
Above all, this is not causal inference. The map does not turn "twenty people said so" into "therefore it is so". It identifies and organises the evidence; the warranting stays the evaluator's job, and is best done with an explicit, written discipline (see [[902 Quality assurance at each step of the causal coding workflow ((quality-assurance))|the quality-assurance companion]] and [[005 Minimalist coding for causal mapping ((minimalist))|the minimalist coding stance]]). Reading a map as if it already proved its pathways, especially across sources who each told only part of the story, is [[The transitivity trap|the transitivity trap]], and it is the single thing most worth guarding against.
