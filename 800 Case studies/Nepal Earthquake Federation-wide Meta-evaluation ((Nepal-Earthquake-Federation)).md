...
--- start-multi-column: nepalColumns
```column-settings  
number of columns: 2  
```
...
![[800 Case studies/img/map-nepal-earthquake-federation-wide-meta-evaluation-nepal-earthquake-fede.jpg]]{width=3cm}

![[800 Case studies/img/map-nepal-earthquake-federation-wide-meta-evaluation-nepal-earthquake-fede.jpg]]{.inline}
