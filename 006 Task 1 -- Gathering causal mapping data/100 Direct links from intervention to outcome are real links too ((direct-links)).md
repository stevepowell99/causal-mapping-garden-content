...
[[020 You can also create consensus causal maps directly ((consensus-maps))]], and in these cases these cheeky direct links are often ignored or curated out of the way. When coding individual sources, and source X says `A --> B --> C` and then and source Y says `A --> C` it is very tempting to recode source X as if they were really saying `A --> B --> C`. 
